...
class TestRequirementValidation:
    ...
    def test_create_requirement_validation_success(self, client):
        ...
        rv.set_address("d3414687-40f4-4346-a267-c2c65117d28c")
        rv.set_requirement("aea92b24-a044-4864-9740-89d3e15b65c7")
    ...
    def test_create_requirement_validation_failure(self, client):
        rv = RequirementValidation()
        rv.set_identity("5e9df058-50d2-4e34-b0d4-d1746b86f41a")
        rv.set_address("d3414687-40f4-4346-a267-c2c65117d28c")
        rv.set_requirement("2efc3427-8ba6-4d50-875d-f2de4a068de8")
