...
class AddressRequirement(DidwwApiModel):
...
class AddressRequirementRepository(ReadOnlyRepository):
    _resource_class = AddressRequirement
    _path = "address_requirements"
